                    ...
                    children: AnimationConfiguration.toStaggeredList(
                        ...
                        children: [
                          CarouselSlider(
                            ...
                            items: cubit.categoriesDetailModel!.result!.images!
                                .map((i) {
                              return Builder(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                        '  ${getDate(cubit.categoriesDetailModel!.result!.updatedAt)}'),
                                  ],
                                ),
                                Padding(
                                  ...
                                  child: ReadMoreText(
                                    ...
                                    trimCollapsedText:
                                        getLang(context, 'categoryReadMore'),
                                    trimExpandedText:
                                        getLang(context, 'categoryReadLess'),
                                    style: const TextStyle(
                                      fontSize: 18,
                                      height: 1.2,
                                      wordSpacing: -2,
                                ...
                                Text(
                                  getLang(context,
                                      'categoryTheMostImportantActivities'),
                                  style: const TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold,
                                  ),
