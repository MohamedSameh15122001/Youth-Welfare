    ...
    return BlocConsumer<AppCubit, AppStates>(
      listener: (context, state) {
        ...
        if (state is CancelActivitySuccessState) {
          showToast(
              text: '${state.cancelModel.message}', state: ToastStates.SUCCESS);
        }

        if (state is RateSuccessState) {
          showToast(
              text: '${state.rateModel.message}', state: ToastStates.SUCCESS);
          AppCubit.get(context).getActivitiesDetailData(
              AppCubit.get(context).categoriesDetailModel!.result!.sId,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  OutlinedButton(
                                                                      onPressed:
                                                                        ...
                                                                        cubit.setRate(
                                                                            categoryID:
                                                                                cubit.categoriesDetailModel!.result!.sId,
